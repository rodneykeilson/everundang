...
| --- | --- | --- |
| Vewaxio | 221110593 | Koordinasi fitur, arsitektur, orkestrasi Docker Compose, konfigurasi Render, demo live |
...
Sumber kode utama:
- Repo GitHub: <https://github.com/vewaxio/everundang>
...
- **GitHub Actions**: workflow `Deploy` (push ke `main` atau manual dispatch) melakukan:
  ...
  - Build & push image backend dan frontend ke `ghcr.io/vewaxio/everundang-*`
