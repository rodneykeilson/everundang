...
> **Anggota & Peran Video**
> - Vewaxio – Host utama, Bagian 1, Bagian 2A/2D/2E, Demo Live (Bagian 3C) & Penutup.
...
- Di browser (Chrome/Edge), buka tiga tab: (1) GitHub repo `https://github.com/vewaxio/everundang` di tab *Code*, (2) tab *Actions*, (3) tab `https://everundang.onrender.com` tetapi **jangan** dimuat dulu (biarkan di halaman kosong sampai Bagian 3C).
...
- **Dialog kunci**:
	...
	3. Perkenalan anggota: "Tim kami terdiri dari Dylan Pratama Khu, Felix Willie, Charles, Jhonsen, dan saya Vewaxio."
...
- **Dialog & Aksi sangat rinci**:
	...
	5. Klik step `Compute image prefix`. Ucapkan: "Di sini kita menyiapkan prefix nama image yaitu `ghcr.io/vewaxio/everundang`. Output step ini dipakai di langkah berikutnya." 
...
- **Dialog & Aksi sangat rinci**:
	...
	4. Scroll ke bagian `Deploys` pada service backend. Ucapkan: "Setiap kali workflow selesai, Render memicu deploy baru yang mengambil image `ghcr.io/vewaxio/everundang-backend:latest`. Di sini terlihat riwayat deploy dan statusnya harus hijau."
